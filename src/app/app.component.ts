...
export class AppComponent {
  ...
  async ngOnInit() {
    let template=`<div class="template-div"><p class="heading-one">Content Projection Heading</p><span class="side-note"><i>content is from "template" variable which is a string</i></span></div>`
